...
ServerBuilder& ServerBuilder::SetMaxReceiveMessageSize(int max_receive_message_size) {
...
ServerBuilder& ServerBuilder::SetMaxSendMessageSize(int max_receive_message_size) {
