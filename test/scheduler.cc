...
TEST(SchedulerTest, Schedulable) {
    struct Foo : public StaticThreadPool::Schedulable {
        ...
        auto Operation() {
            return Schedule([this]() { return Just(i); }) |
                   [](auto i) { return i + 1; };
        }
...
TEST(SchedulerTest, PingPong) {
    struct Streamer : public StaticThreadPool::Schedulable {
        ...
        auto Stream() {
            ...
            return Repeat() |
                   Until(Schedule([this]() { return Just(count > 5); })) |
                   Map(Schedule([this]() mutable { return Just(count++); }));
        }
    ...
    struct Listener : public StaticThreadPool::Schedulable {
        ...
        auto Listen() {
            ...
            return Map(Schedule([this](int i) {
                       count++;
                       return Just(i);
                   })) |
                   Loop() | [this](auto&&...) { return count; };
        }
