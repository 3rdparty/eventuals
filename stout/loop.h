...
struct Loop {
    ...
    static auto create(K k, Context context, Start start, Body body,
                       ...
                       Interrupt interrupt) {
        return Loop<K, Context, Start, Body, Ended, Fail, Stop, Interrupt,
                    Value, Errors...>{
...
struct IsLoop<detail::Loop<K, Context, Start, Body, Ended, Fail, Stop,
                           Interrupt, Value, Errors...>> : std::true_type {};

template<typename K, typename Context, typename Start, typename Body,
         typename Ended, typename Fail, typename Stop, typename Interrupt,
         typename Value, typename... Errors>
struct IsContinuation<detail::Loop<K, Context, Start, Body, Ended, Fail, Stop,
...
template<typename K, typename Context, typename Start, typename Body,
         typename Ended, typename Fail, typename Stop, typename Interrupt,
         typename Value, typename... Errors>
struct HasLoop<detail::Loop<K, Context, Start, Body, Ended, Fail, Stop,
                            Interrupt, Value, Errors...>> : std::true_type {};

template<typename K, typename Context, typename Start, typename Body,
         typename Ended, typename Fail, typename Stop, typename Interrupt,
         typename Value, typename... Errors>
struct HasTerminal<detail::Loop<K, Context, Start, Body, Ended, Fail, Stop,
                                Interrupt, Value, Errors...>> :
    HasTerminal<K> {};

template<typename Value, typename... Errors>
auto Loop() {
    return detail::Loop<Undefined, Undefined, Undefined, Undefined, Undefined,
                        Undefined, Undefined, Undefined, Value, Errors...>{
